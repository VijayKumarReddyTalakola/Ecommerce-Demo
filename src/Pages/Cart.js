...
const Cart = () => {
    ...
    if(!cart.length) return <div className=' flex justify-center items-center text-4xl min-h-[50vh]'>Cart is Empty</div>

  return (
    <div className="container mx-auto mt-7">
        <div className="shadow-md my-5 md:flex flex-row">
            <div className="bg-white p-7 md:w-3/4 ">
                <div className="flex justify-between border-b pb-8 ">
                    <h1 className="font-semibold text-2xl">Shopping Cart</h1>
                    <h2 className="font-semibold text-2xl">{cart?.length} items </h2>
                </div>
                <div className="flex mt-10 mb-5 w-full px-2">
                    <h3 className="font-semibold text-gray-600 text-xs uppercase w-4/5 md:w-2/5">Product Details</h3>
                    <h3 className="font-semibold text-center text-gray-600 text-xs uppercase w-1/5 md:w-1/5">Quantity</h3>
                    <h3 className="font-semibold text-center text-gray-600 text-xs uppercase w-1/5 md:w-1/5">Price</h3>
                    <h3 className="font-semibold text-center text-gray-600 text-xs uppercase w-1/5 md:w-1/5">Total</h3>
                </div>
                {
                    cart.map(item=>{
                        return (
                            <div className="flex px-3 py-2 items-center hover:bg-gray-100 md:px-6 -mx-8">
                                ...
                                <div className="flex justify-center w-1/5">
                                    ...
                                    <input type="text" className="-mx-1 border text-center w-8 md:mx-2" value={item?.quantity} />
            ...
            <div id='summary' className=" px-8 py-7 md:w-1/4">
